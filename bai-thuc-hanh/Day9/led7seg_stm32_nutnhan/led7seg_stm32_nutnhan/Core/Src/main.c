...
//  SW1 = ButtonPressed(button, 0)
//  SW2 = ButtonPressed(button, 1)
//  SW3 = ButtonPressed(button, 2)
//  SW4 = ButtonPressed(button, 3)
  ...
  while (1)
  {
      ...
      case 1:
          ...
          for(uint32_t j = 0; j < 20; j++)
          {
              ...
              LED_display(10,10,10,chuc,donvi);
              HAL_Delay(10);
          }
          HAL_GPIO_WritePin(COI_GPIO_Port, COI_Pin, GPIO_PIN_RESET);
          mode = 0;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, OE_Pin|ST_CP_Pin|SH_LD_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : OE_Pin COI_Pin ST_CP_Pin SH_LD_Pin */
  GPIO_InitStruct.Pin = OE_Pin|COI_Pin|ST_CP_Pin|SH_LD_Pin;
